...
class PoseRecognitionDataset(Dataset):
    def __init__(self, poses_dir=None, sequence_length=30, keypoints_seq=None, split='train'):
    ...
    def _prepare_file_list(self):
        ...
        for class_name in os.listdir(self.poses_dir):
            class_dir = os.path.join(self.poses_dir, class_name, self.split)
...
if __name__ == "__main__":
    # Example usage
    poses_dir = '/home/aniyazi/masters_degree/action_classification/person_recognition_dataset'
    dataset = PoseRecognitionDataset(poses_dir, sequence_length=30, split='train')
